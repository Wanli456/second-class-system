...
export default function OtherCollegeRegistrationPage() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!scoringTable && !existingScoring) { setError('请上传赋分表。'); return; }
    setSubmitting(true);
    try {
      let scoringUpload: UploadedFile;
      let recordUpload: UploadedFile | null = null;
      try {
      ...
      if (recordPhoto || existingRecordPhoto) {
        try {
