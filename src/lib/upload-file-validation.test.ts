...
assert.equal(detectFileKindFromBytes(Buffer.from('RIFF0000WEBP')), 'image');
assert.equal(detectFileKindFromBytes(Buffer.from('RIFF0000WAVE')), null);
assert.equal(detectFileKindFromBytes(Buffer.from('0000ftypheic')), 'image');
assert.equal(detectFileKindFromBytes(Buffer.from('0000ftypmp42')), null);
