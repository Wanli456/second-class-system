...
import { isValidDateRange } from './other-college-validation';

assert.equal(OTHER_COLLEGES.length, 5);
...
assert.equal(isOtherCollege('校社团'), true);
...
assert.equal(isValidDateRange('2026-08-23T10:00', '2026-08-23T10:00'), false);
assert.equal(isValidDateRange('2026-08-23T10:00', '2026-08-23T11:00'), true);
