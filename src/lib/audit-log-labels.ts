 ...
 * 操作日志的中文展示。
 *
 * 这里只放纯映射与格式化函数，**不能引入任何数据库/Node 内置模块**，
 * 因为数据治理页面是客户端组件，会直接打包这个文件。
 */
...
export const AUDIT_ACTION_LABELS: Record<string, string> = {
  ...
  create_leave_slip: '提交假条', resubmit_leave_slip: '重新提交假条', update_leave_slip: '修改假条', delete_leave_slip: '删除假条', review_leave_slip: '查对假条',
  create_original_leave_slip: '提交原假条', resubmit_original_leave_slip: '重新提交原假条', delete_original_leave_slip: '删除原假条',
  create_attendance_work: '新增考勤安排', update_attendance_work: '重新提交考勤安排', review_attendance_work: '审核考勤安排',
  create_evening_study_schedule: '新增晚自习安排', resubmit_evening_study_schedule: '重新提交晚自习安排', update_evening_study_schedule: '修改晚自习安排', delete_evening_study_schedule: '删除晚自习安排',
  create_evening_study_attendance: '登记晚自习考勤', resubmit_evening_study_attendance: '重新提交晚自习考勤',
  ...
  create_other_college_registration: '其他学院登记', resubmit_other_college_registration: '重新提交其他学院登记',
...
export const AUDIT_FIELD_LABELS: Record<string, string> = {
  ...
  scoringStatus: '赋分状态', participantCount: '参与人数', submissionCount: '提交次数', automatic: '自动触发',
